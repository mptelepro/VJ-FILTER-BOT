...
URL = "https://variable-coletta-minnalmurali.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://variable-coletta-minnalmurali.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://variable-coletta-minnalmurali.koyeb.app/".format(FQDN)
else:
    URL = "https://variable-coletta-minnalmurali.koyeb.app/".format(FQDN)
