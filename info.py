...
URL = "https://minnalmurali-ahbp.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://minnalmurali-ahbp.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://minnalmurali-ahbp.onrender.com/".format(FQDN)
else:
    URL = "https://minnalmurali-ahbp.onrender.com/".format(FQDN)
