...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001789493583 -1001511960365 -1001769474138 -1001174819000 -1001351202807 -1001351202807 -1001727256870 -1001500584570').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Zebhamol:Zebhamol@cluster0.8sqenn3.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://minnalmurali.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://minnalmurali.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://minnalmurali.onrender.com/".format(FQDN)
else:
    URL = "https://minnalmurali.onrender.com/".format(FQDN)
